    ...
    <Card hover className="group">
      <CardContent className="p-5">
        ...
        <div className="flex items-start justify-between mb-3">
          <h3 className="font-semibold text-omni-black text-lg leading-tight pr-2">
            {project.name}
          </h3>
        ...
        {client && (
          <div className="flex items-center gap-2 mb-4">
            ...
            <div>
              <p className="text-sm font-medium text-omni-black">{client.name}</p>
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-1.5">
            ...
            <span className="text-sm font-semibold text-omni-black">{project.progress}%</span>
          </div>
        ...
        <Link href={`/project/${project.id}`}>
          <Button
            variant="outline"
            size="sm"
            className="w-full group-hover:border-omni-yellow group-hover:bg-omni-yellow/10"
