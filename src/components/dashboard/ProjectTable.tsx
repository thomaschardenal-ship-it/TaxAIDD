      ...
      <table className="data-table">
        ...
        <tbody>
          {projects.map(project => {
            ...
            return (
              <tr key={project.id} className="hover:bg-omni-gray-light/50">
                <td>
                  <span className="font-medium text-omni-black">{project.name}</span>
                </td>
                <td>
                  {client && (
                ...
                <td>
                  <Link
                    ...
                    className="inline-flex items-center gap-1 text-omni-purple hover:underline text-sm"
                  >
                    Ouvrir
