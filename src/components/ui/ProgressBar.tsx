...
export default function ProgressBar({
  ...
  return (
    <div className={`w-full ${className}`}>
      <div className={`w-full bg-omni-gray-light rounded-full overflow-hidden ${sizeClasses[size]}`}>
        <div
...
export function DomainProgressBar({ domain, received, total }: DomainProgressBarProps) {
  ...
  return (
    <div className="w-full">
      <div className="w-full h-2 bg-omni-gray-light rounded-full overflow-hidden">
        <div
