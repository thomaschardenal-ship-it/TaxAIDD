...
export default function OrgChart({ companies }: OrgChartProps) {
  ...
  return (
    <div className="bg-white rounded-xl border border-gray-100 p-6">
      <h3 className="text-lg font-semibold text-omni-black mb-6">Structure Juridique</h3>
  ...
  return (
    ...
    >
      ...
      <div className="text-center">
        <p className="font-semibold text-omni-black">{company.name}</p>
        {company.legalForm && (
      ...
      {/* Tooltip on hover */}
      {isHovered && (
        <div className="absolute top-full left-1/2 -translate-x-1/2 mt-2 z-10 bg-omni-black text-white px-3 py-2 rounded-lg text-xs whitespace-nowrap shadow-lg">
