import { ReportElement, IRLItem, QAItem } from '@/types';
...
export const irlItems: Record<string, IRLItem[]> = {
  'project-1': [
    ...
    { category: 'Corporate', document: 'Management Packages', status: 'pending' },
    ...
    { category: 'TAX', document: 'CA3 YTD', status: 'pending' },
    ...
    { category: 'Social', document: 'Travailleurs externes', status: 'missing' },
    ...
    { category: 'IP/IT', document: 'Brevets & Dessins', status: 'missing' },
