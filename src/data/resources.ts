...
export const scopeTemplates: ScopeTemplate[] = [
  {
    ...
    sections: [
      ...
      'TVA — Réconciliation et conformité déclarative',
      'Autres taxes (CET, taxes sur salaires, TVS)',
      'Crédits d\'impôt (CIR, CII, JEI)',
      'Prix de transfert — Revue documentaire',
      'Contentieux fiscal en cours et risques latents',
